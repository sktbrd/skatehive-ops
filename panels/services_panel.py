...
def create_services_panel(monitor) -> Panel:
    ...
    table.add_column("Response", style="yellow", width=7)
    table.add_column("Uptime", style="magenta", width=8)
    table.add_column("CPU", style="red", width=5)
    table.add_column("Memory", style="blue", width=7)
