...
def create_unified_video_activity_panel():
    ...
    try:
        ...
        # Create table for recent operations with expanded column widths to use full space
        ...
        table.add_column("User", style="green", width=25)
        table.add_column("Device", style="blue", width=15)
        ...
        for log in logs[:8]:  # Show last 8 operations
            ...
            # Service info (increased width from 10 to 15)
            ...
            # Format user with HP (increased width from 15 to 25)
            user = log.get('user', log.get('creator', 'anonymous'))[:22]
            ...
            # Format filename (increased width from 18 to 35)
